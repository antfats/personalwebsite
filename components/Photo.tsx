    ...
    return (
        <div className="w-full h-full relative overflow-hidden rounded-full">
            ...
            >
                ...
                >
                    <div className="w-[298px] h-[298px] xl:w-[498px] xl:h-[498px] overflow-hidden mix-blend-lighten absolute">
                        <Image src="/assets/anthonyfatato2.png" priority quality={100} fill alt="img1" className="object-contain" />
                    </div>
                </motion.div>
                {/* circle around image */}
